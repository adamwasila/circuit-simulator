package circuit;// stub implementation of circuit.DiacElm, based on circuit.SparkGapElm
// FIXME need to add circuit.DiacElm.java to srclist
// FIXME need to uncomment circuit.DiacElm line from circuit.CirSim.java
