package circuit;// stub implementation of circuit.TriacElm, based on circuit.SCRElm
// FIXME need to add circuit.TriacElm to srclist
// FIXME need to uncomment circuit.TriacElm line from circuit.CirSim.java
