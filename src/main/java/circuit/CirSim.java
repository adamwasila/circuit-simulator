package circuit;// circuit.CirSim.java (c) 2010 by Paul Falstad
...
//    Vector setupList;
    ...
    CirSim(Circuit a) {
	super("circuit.Circuit Simulator v1.6.1a");
	applet = a;
	useFrame = false;
    }
...
//	euroResistorCheckItem.setState(euro);
	...
	Label l;
	l = new Label("Current circuit.Circuit:");
	l.setFont(f);
...
//	setupList = new Vector();
	...
	elmMenu.add(elmScopeMenuItem = getMenuItem("View in circuit.Scope"));
...
//	    impDialog = new circuit.ImportExportClipboardDialog(this,
//		circuit.ImportExportDialog.Action.IMPORT);
	pushUndo();
	impDialog.execute();
    }
...
//	    expDialog = new circuit.ImportExportClipboardDialog(this,
//		 circuit.ImportExportDialog.Action.EXPORT);
	}
