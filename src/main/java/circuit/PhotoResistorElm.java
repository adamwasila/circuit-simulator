package circuit;// stub circuit.PhotoResistorElm based on circuit.SparkGapElm
// FIXME need to uncomment circuit.PhotoResistorElm line from circuit.CirSim.java
// FIXME need to add circuit.PhotoResistorElm.java to srclist
...
class PhotoResistorElm extends CircuitElm {
	...
	draw2Leads(g);
	// FIXME need to draw properly, see circuit.ResistorElm.java
