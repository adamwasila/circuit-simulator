package circuit.element;// stub implementation of circuit.element.DiacElm, based on circuit.element.SparkGapElm
// FIXME need to add circuit.element.DiacElm.java to srclist
// FIXME need to uncomment circuit.element.DiacElm line from circuit.CirSim.java
