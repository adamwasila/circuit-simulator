package circuit.element;// stub circuit.element.PhotoResistorElm based on circuit.element.SparkGapElm
// FIXME need to uncomment circuit.element.PhotoResistorElm line from circuit.CirSim.java
// FIXME need to add circuit.element.PhotoResistorElm.java to srclist

import circuit.EditInfo;
...
public class PhotoResistorElm extends CircuitElm {
	...
	draw2Leads(g);
	// FIXME need to draw properly, see circuit.element.ResistorElm.java
