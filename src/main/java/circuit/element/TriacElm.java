package circuit.element;// stub implementation of circuit.element.TriacElm, based on circuit.element.SCRElm
// FIXME need to add circuit.element.TriacElm to srclist
// FIXME need to uncomment circuit.element.TriacElm line from circuit.CirSim.java

import circuit.Diode;
