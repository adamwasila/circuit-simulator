package circuit.element;// stub circuit.element.ThermistorElm based on circuit.element.SparkGapElm
// FIXME need to uncomment circuit.element.ThermistorElm line from circuit.CirSim.java
// FIXME need to add circuit.element.ThermistorElm.java to srclist
