package circuit;// stub circuit.ThermistorElm based on circuit.SparkGapElm
// FIXME need to uncomment circuit.ThermistorElm line from circuit.CirSim.java
// FIXME need to add circuit.ThermistorElm.java to srclist
